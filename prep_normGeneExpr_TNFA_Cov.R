...
genoPCA <- genoPCA[1:3, ]
phenoPCA <- read.table(paste0("covFiles/normGeneExpr_TNFA_qtlTools_Ready.pca"), header = T)
...
write.table(cov, paste0("covFiles/normGeneExpr_TNFA_geno3pc_pheno40pc.txt"), sep = "\t", row.names = F, quote = F)
