...
QTLtools pca --bed phenoFiles/normGeneExpr_TNFA_qtlTools_Ready.bed.gz --scale --center --out covFiles/normGeneExpr_TNFA_qtlTools_Ready
# Combine geno and TNFA expression pheno PCA
Rscript brbSeq_scripts/prep_normGeneExpr_TNFA_Cov.R
...
do
    ...
    zgrep -w "^#chr" phenoFiles/normGeneExpr_TNFA_qtlTools_Ready.bed.gz > phenoFiles/chr${chr}.bed
    zgrep -w ^${chr} phenoFiles/normGeneExpr_TNFA_qtlTools_Ready.bed.gz | sort -nk2 >> phenoFiles/chr${chr}.bed
    ...
    QTLtools cis \
        ...
        --cov covFiles/normGeneExpr_TNFA_geno3pc_pheno40pc.txt \
        --window 1000000 \
        --std-err \
        --grp-best \
        --out geneExprTNFA_brbSeq_cisEQTL/chr${chr}_geneExprTNFA_brbSeq_cisEQTL_nominal.txt.gz \
        --nominal 1
...
do
    ...
    QTLtools cis \
        ...
        --std-err \
        --grp-best \
        --out geneExprTNFA_brbSeq_cisEQTL/chr${chr}_geneExprTNFA_brbSeq_cisEQTL_permute.txt.gz \
        --permute 1000

done


zcat geneExprTNFA_brbSeq_cisEQTL/*_permute.txt.gz | gzip -c > geneExprTNFA_brbSeq_cisEQTL/geneExprTNFA_brbSeq_cisEQTL_permute_ALL.txt.gz
zcat geneExprTNFA_brbSeq_cisEQTL/*_nominal.txt.gz | gzip -c > geneExprTNFA_brbSeq_cisEQTL/geneExprTNFA_brbSeq_cisEQTL_nominal_ALL.txt.gz
zcat geneExprTNFA_brbSeq_cisEQTL/geneExprTNFA_brbSeq_cisEQTL_nominal_ALL.txt.gz | awk -F'\t' '$14 < 0.05' | gzip -c > geneExprTNFA_brbSeq_cisEQTL/geneExprTNFA_brbSeq_cisEQTL_nominal_ALL_pval0.05.txt.gz
...
QTLtools pca --bed phenoFiles/normGeneExpr_UNTR_qtlTools_Ready.bed.gz --scale --center --out covFiles/normGeneExpr_UNTR_qtlTools_Ready
# Combine geno and UNTR expression pheno PCA
Rscript brbSeq_scripts/prep_normGeneExpr_UNTR_Cov.R
...
do
    ...
    # Process expression files
    zgrep -w "^#chr" phenoFiles/normGeneExpr_UNTR_qtlTools_Ready.bed.gz > phenoFiles/chr${chr}.bed
    zgrep -w ^${chr} phenoFiles/normGeneExpr_UNTR_qtlTools_Ready.bed.gz | sort -nk2 >> phenoFiles/chr${chr}.bed
    cat phenoFiles/chr${chr}.bed | bgzip > phenoFiles/chr${chr}.bed.gz
    tabix -f phenoFiles/chr${chr}.bed.gz
    rm phenoFiles/chr${chr}.bed
    ...
    QTLtools cis \
        --vcf genoFiles/chr${chr}.vcf.gz \
        --bed phenoFiles/chr${chr}.bed.gz \
        --cov covFiles/normGeneExpr_UNTR_geno3pc_pheno40pc.txt \
        --window 1000000 \
        --std-err \
        --grp-best \
        --out geneExprUNTR_brbSeq_cisEQTL/chr${chr}_geneExprUNTR_brbSeq_cisEQTL_nominal.txt.gz \
        --nominal 1
...
do
    ...
    QTLtools cis \
        ...
        --std-err \
        --grp-best \
        --out geneExprUNTR_brbSeq_cisEQTL/chr${chr}_geneExprUNTR_brbSeq_cisEQTL_permute.txt.gz \
        --permute 1000

done


zcat geneExprUNTR_brbSeq_cisEQTL/*_permute.txt.gz | gzip -c > geneExprUNTR_brbSeq_cisEQTL/geneExprUNTR_brbSeq_cisEQTL_permute_ALL.txt.gz
zcat geneExprUNTR_brbSeq_cisEQTL/*_nominal.txt.gz | gzip -c > geneExprUNTR_brbSeq_cisEQTL/geneExprUNTR_brbSeq_cisEQTL_nominal_ALL.txt.gz
zcat geneExprUNTR_brbSeq_cisEQTL/geneExprUNTR_brbSeq_cisEQTL_nominal_ALL.txt.gz | awk -F'\t' '$14 < 0.05' | gzip -c > geneExprUNTR_brbSeq_cisEQTL/geneExprUNTR_brbSeq_cisEQTL_nominal_ALL_pval0.05.txt.gz
