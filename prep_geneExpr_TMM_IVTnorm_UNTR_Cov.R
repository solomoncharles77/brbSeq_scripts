...
genoPCA <- genoPCA[1:3, ]
phenoPCA <- read.table(paste0("covFiles/geneExpr_TMM_IVTnorm_UNTR_qtlTools_Ready.pca"), header = T)
...
write.table(cov, paste0("covFiles/geneExpr_TMM_IVTnorm_UNTR_geno3pc_pheno40pc.txt"), sep = "\t", row.names = F, quote = F)
