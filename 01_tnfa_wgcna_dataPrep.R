...
# save plot
sizeGrWindow(12,9)
png(file = "wgcnaPlots/huvecTNFA_WGCNA_sampleClustering.png", width = 480, height = 480, units = "px");
par(cex = 0.6);
par(mar = c(0,4,2,0))
plot(sampleTree, main = "Sample clustering to detect outliers",
     sub="", xlab="", cex.lab = 1.5,
...
# Plot the results:
png(file = "wgcnaPlots/huvecTNFA_WGCNA_softThresholdPower.png", width = 480, height = 380)
#sizeGrWindow(9, 5)
par(mfrow = c(1,2));
cex1 = 0.9;
...
save(datExpr, sft, sampleTree,  file = "wgcnaFiles/huvecTNFA_WGCNA_dataInput.RData" )
